...
#[test]
fn part1_example1() {
    let input = include_str!(concat!("../input/day10.example1.txt"));
    assert_eq!(part1(input), 4);
}

#[test]
fn part1_example2() {
    let input = include_str!(concat!("../input/day10.example2.txt"));
...
#[test]
fn part2_example3() {
    let input = include_str!("../input/day10.example3.txt");
    assert_eq!(part2(input), 4);
}

#[test]
fn part2_example4() {
    let input = include_str!("../input/day10.example4.txt");
    assert_eq!(part2(input), 4);
}

#[test]
fn part2_example5() {
    let input = include_str!("../input/day10.example5.txt");
    assert_eq!(part2(input), 8);
}

#[test]
fn part2_example6() {
    let input = include_str!("../input/day10.example6.txt");
