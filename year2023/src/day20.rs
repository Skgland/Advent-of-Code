...
#[test]
fn part1_example1() {
    let input = include_str!(concat!("../input/day20.example1.txt"));
    assert_eq!(part1(input), 8000 * 4000);
}

#[test]
fn part1_example2() {
    let input = include_str!(concat!("../input/day20.example2.txt"));
...
pub fn print_graph() {
    ...
    let input = parse_input(include_str!(concat!("../input/day20.txt")));
