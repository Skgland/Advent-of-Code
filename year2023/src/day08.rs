...
#[test]
fn part1_example1() {
    let input = include_str!(concat!("../input/day08.example1.txt"));
    assert_eq!(part1(input), 2);
}

#[test]
fn part1_example2() {
    let input = include_str!(concat!("../input/day08.example2.txt"));
...
#[test]
fn part2_example3() {
    let input = include_str!("../input/day08.example3.txt");
