...
#[test]
fn part1_example1() {
    let input = include_str!(concat!("../input/day02.example1.txt"));
    assert_eq!(part1(input), 2 * 6 + 2 * 12 + 2 * 8 + 6);
}

#[test]
fn part1_example2() {
    let input = include_str!(concat!("../input/day02.example2.txt"));
...
#[test]
fn part2_example1() {
    let input = include_str!("../input/day02.example1.txt");
    assert_eq!(part2(input), 2 + 2 + 3 + 3 + 2 * 3 * 4);
}

#[test]
fn part2_example2() {
    let input = include_str!("../input/day02.example2.txt");
